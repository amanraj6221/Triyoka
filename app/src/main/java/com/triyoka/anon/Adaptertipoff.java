...
public class Adaptertipoff extends RecyclerView.Adapter<Adaptertipoff.MyHolder> {
    ...
    public Adaptertipoff(Context context, List<Modeltipoff> modelPosts) {
    ...
    List<Modeltipoff> modelPosts;

    @NonNull
    @Override
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_tipoffrow, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position){
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(holder.itemView.getContext(), tipofflikedby.class);
        ...
        holder.comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, tipoffdetails.class);
        ...
        liekeref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(pid).hasChild(myuid)) {
                    holder.likebtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_action_like, 0, 0, 0);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            picture = itemView.findViewById(R.id.pimagetv);
